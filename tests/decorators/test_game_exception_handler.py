...
from decorators.hundred_and_ten_exception import handle_exception
...
class TestGameExceptionHandler(TestCase):
    ...
    def test_does_nothing_when_no_exception(self):
        ...
        status_code = 204
        wrapped_func = handle_exception(lambda r: func.HttpResponse(status_code=status_code))
    ...
    def test_returns_bad_request_when_exception_is_caught(self):
        ...
        wrapped_func = handle_exception(test_func)
